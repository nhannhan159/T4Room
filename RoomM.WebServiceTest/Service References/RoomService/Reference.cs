...
namespace RoomM.WebServiceTest.RoomService {
    ...
    public interface IRoomService {
        ...
        RoomM.Models.Room[] GetByRoomTypeId(long roomTypeId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IRoomService/GetByRoomTypeId", ReplyAction="http://tempuri.org/IRoomService/GetByRoomTypeIdResponse")]
        System.Threading.Tasks.Task<RoomM.Models.Room[]> GetByRoomTypeIdAsync(long roomTypeId);
        ...
        RoomM.Models.Room[] GetRoomListLimitByRegister(int limit);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IRoomService/GetRoomListLimitByRegister", ReplyAction="http://tempuri.org/IRoomService/GetRoomListLimitByRegisterResponse")]
        System.Threading.Tasks.Task<RoomM.Models.Room[]> GetRoomListLimitByRegisterAsync(int limit);
    ...
    public partial class RoomServiceClient : System.ServiceModel.ClientBase<RoomM.WebServiceTest.RoomService.IRoomService>, RoomM.WebServiceTest.RoomService.IRoomService {
        ...
        public RoomM.Models.Room[] GetByRoomTypeId(long roomTypeId) {
            return base.Channel.GetByRoomTypeId(roomTypeId);
        }
        
        public System.Threading.Tasks.Task<RoomM.Models.Room[]> GetByRoomTypeIdAsync(long roomTypeId) {
            return base.Channel.GetByRoomTypeIdAsync(roomTypeId);
        }
        
        public RoomM.Models.Room[] GetRoomListLimitByRegister(int limit) {
            return base.Channel.GetRoomListLimitByRegister(limit);
        }
        
        public System.Threading.Tasks.Task<RoomM.Models.Room[]> GetRoomListLimitByRegisterAsync(int limit) {
